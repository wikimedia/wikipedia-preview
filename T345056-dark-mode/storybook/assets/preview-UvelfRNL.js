import{s as c,m as o,b as p}from"./fullscreen-wh-42eOW.js";const m=(e,i)=>{const d=document.createElement("div");return d.classList.add("wikipediapreview-gallery-row"),e.forEach(r=>{const a=document.createElement("div");a.classList.add("wikipediapreview-gallery-image"),a.style.backgroundImage=`url(${r.thumb})`,a.addEventListener("click",s=>{const v=s.target.style.backgroundImage.slice(4,-1).replace(/"/g,"");c(e,v,i.lang,i.dir)}),d.appendChild(a)}),d},n=(e,i="")=>`
