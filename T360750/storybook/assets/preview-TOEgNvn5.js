import{s as c,m as v,b as p}from"./fullscreen-7DcogfXJ.js";const m=(e,i)=>{const d=document.createElement("div");return d.classList.add("wikipediapreview-gallery-row"),e.forEach(r=>{const a=document.createElement("div");a.classList.add("wikipediapreview-gallery-image"),a.style.backgroundImage=`url(${r.thumb})`,a.addEventListener("click",s=>{const o=s.target.style.backgroundImage.slice(4,-1).replace(/"/g,"");c(e,o,i.lang,i.dir)}),d.appendChild(a)}),d},t=(e,i="")=>`
...
`.trim(),l=(e,i,d)=>`<a href="${p(e,i,d)}" target="_blank" class="wikipediapreview-cta-readonwiki">${v(e,"read-on-wiki")}</a>`,n=(e,i,d,r,a,s)=>{const o=s==="detect"?"":`wikipediapreview-${s}-theme`;return`
	...
	`.trim();return n(i,e,d,t(i),a,r)},y=(e,i,d,r,a)=>{const s=`<span>${v(i,"preview-error-message")}</span>`,o=l(i,d,e);return n(i,e,r,t(i),w("error",s,o),a)},$=(e,i,d,r,a)=>{const s=`<span>${v(i,"preview-disambiguation-message",d)}</span>`,o=l(i,d,e);return n(i,e,r,t(i),w("disambiguation",s,o),a)},u=(e,i,d,r)=>{const a=`<span>${v(i,"preview-offline-message")}</span>`,s=`<a>${v(i,"preview-offline-cta")}</a>`;return n(i,e,d,t(i),w("offline",a,s),r)};export{b as a,y as b,$ as c,u as d,m as g,g as r};
