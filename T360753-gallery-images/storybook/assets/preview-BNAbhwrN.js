...
`.trim(),w=(e,i,d)=>`<a href="${p(e,i,d)}" target="_blank" class="wikipediapreview-footer-link-cta">${v(e,"read-on-wiki")}</a>`,l=(e,i,d,r,a,s)=>{const o=s==="detect"?"":`wikipediapreview-${s}-theme`;return`
	...
	`.trim()},b=(e,i,d,r)=>{const a=i.imgUrl,s=`
		...
		`.trim();return l(e,d,i.dir,n(e,d,a,i.media),s,r)},y=(e,i,d,r)=>{const a=`
	...
	`.trim();return l(i,e,d,n(i,e),a,r)},$=(e,i,d,r,a)=>{const s=`<span>${v(i,"preview-error-message")}</span>`,o=w(i,d,e);return l(i,e,r,n(i,e),t("error",s,o),a)},u=(e,i,d,r,a)=>{const s=`<span>${v(i,"preview-disambiguation-message",d)}</span>`,o=w(i,d,e);return l(i,e,r,n(i,e),t("disambiguation",s,o),a)},f=(e,i,d,r)=>{const a=`<span>${v(i,"preview-offline-message")}</span>`,s=`<a>${v(i,"preview-offline-cta")}</a>`;return l(i,e,d,n(i,e),t("offline",a,s),r)};export{y as a,$ as b,u as c,f as d,b as r};
