import{s as c,m as s,b as w}from"./fullscreen-JRNfoxVh.js";const m=(e,i)=>{const d=document.createElement("div");return d.classList.add("wikipediapreview-gallery-row"),e.forEach(r=>{const a=document.createElement("div");a.classList.add("wikipediapreview-gallery-image"),a.style.backgroundImage=`url(${r.thumb})`,a.addEventListener("click",o=>{const l=o.target.style.backgroundImage.slice(4,-1).replace(/"/g,"");c(e,l,i.lang,i.dir)}),d.appendChild(a)}),d},v=(e,i="")=>`
...
//# sourceMappingURL=preview-PWvtmBwl.js.map
