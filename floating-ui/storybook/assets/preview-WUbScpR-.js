import{s as c,m as v,b as p}from"./fullscreen-xOM45o0j.js";const m=(e,i)=>{const d=document.createElement("div");return d.classList.add("wikipediapreview-gallery-row"),e.forEach(r=>{const a=document.createElement("div");a.classList.add("wikipediapreview-gallery-image"),a.style.backgroundImage=`url(${r.thumb})`,a.addEventListener("click",s=>{const o=s.target.style.backgroundImage.slice(4,-1).replace(/"/g,"");c(e,o,i.lang,i.dir)}),d.appendChild(a)}),d},t=(e,i,d="")=>`
