...
const getReadOnWikiCta = ( lang, title, isMobile ) => {
	return `<a href="${ buildWikipediaUrl( lang, title, isMobile ) }" target="_blank" class="wikipediapreview-cta-readonwiki">${ msg( lang, 'read-on-wiki' ) }</a>`
}
	...
	const imageUrl = data.imgUrl,
		bodyContent = `
			...
			<div class="wikipediapreview-footer">
				...
				<a href="${ buildWikipediaUrl( lang, data.title, isMobile ) }" class="wikipediapreview-footer-cta wikipediapreview-footer-cta-readonwiki" target="_blank">${ msg( lang, 'read-more' ) }</a>
			</div>
		`.trim()
