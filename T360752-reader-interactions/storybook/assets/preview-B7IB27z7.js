import{b as t,m as v,g as c}from"./utils-BcOSYxzz.js";const p=(e,i,d="")=>`
...
`.trim(),l=(e,i,d)=>`<a href="${t(e,i,d)}" target="_blank" class="wikipediapreview-footer-link-cta">${v(e,"read-on-wiki")}</a>`,w=(e,i,d,r,a,s)=>{const o=s==="detect"?"":`wikipediapreview-${s}-theme`;return`
	...
	`.trim()},m=(e,i,d,r)=>{const a=i.imgUrl,s=`
		...
		`.trim();return w(e,d,i.dir,p(e,d,a),s,r)},b=(e,i,d,r)=>{const a=`
	...
	`.trim();return w(i,e,d,p(i,e),a,r)},g=(e,i,d,r,a)=>{const s=`<span>${v(i,"preview-error-message")}</span>`,o=l(i,d,e);return w(i,e,r,p(i,e),n("error",s,o),a)},$=(e,i,d,r,a)=>{const s=`<span>${v(i,"preview-disambiguation-message",d)}</span>`,o=l(i,d,e);return w(i,e,r,p(i,e),n("disambiguation",s,o),a)},y=(e,i,d,r)=>{const a=`<span>${v(i,"preview-offline-message")}</span>`,s=`<a>${v(i,"preview-offline-cta")}</a>`;return w(i,e,d,p(i,e),n("offline",a,s),r)};export{b as a,g as b,$ as c,y as d,m as r};
