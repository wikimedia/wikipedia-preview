...
describe("Wikimedia english page test", function () {
  ...
  it("cheching the title", () => {
    airticlePage
      .getTitle()
      .should("have.text", "Gili Trawangan");
  });
  ...
  it("cheching the popups Lombok", () => {
      airticlePage.getSpan1A().should('have.text','Lombok')
      airticlePage.getSpan1A().should(
        "have.attr",
        "href",
    ...
    it("cheching the popups Gili Meno", () => {
  ...
  it("cheching the footer", () => {
    ...
    //   <a href="" target="_blank" data-wp-title="Gili_Trawangan" data-wp-lang="id"></a>
      .contains("Gili Trawangan").trigger('mouseenter')
      .should(
        "have.attr",
        "href",
