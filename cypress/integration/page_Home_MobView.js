...
describe('Testing HomePage for Mobileview', () => {
  ...
  it('Check Header Font-Size', () => {
    cy.get('body > div.header').should('be.visible').should('have.css', 'font-size', '18px')  
  })
  ...
  it('Check English Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(1) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
  ...
  it('Check Bahasa Indonesia Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(2) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
  ...
  it('Check Hindi Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(3) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
  ...
  it('Check Thai Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(4) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
  ...
  it('Check Spanish Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(5) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
  ...
  it('Check French Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(6) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
  ...
  it('Check Arabic Content ', () => {
    ...
    cy.get('body > div.container > div > div:nth-child(7) > a > div.title').should('have.css', 'font-size', '16px') //Validating font size of title
  })
