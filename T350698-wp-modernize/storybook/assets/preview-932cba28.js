import{s as c,m as s,b as w}from"./fullscreen-03936f70.js";const m=(e,i)=>{const d=document.createElement("div");return d.classList.add("wikipediapreview-gallery-row"),e.forEach(a=>{const r=document.createElement("div");r.classList.add("wikipediapreview-gallery-image"),r.style.backgroundImage=`url(${a.thumb})`,r.addEventListener("click",o=>{const l=o.target.style.backgroundImage.slice(4,-1).replace(/"/g,"");c(e,l,i.lang,i.dir)}),d.appendChild(r)}),d};const v=(e,i="")=>`
...
//# sourceMappingURL=preview-932cba28.js.map
