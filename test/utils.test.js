...
describe( 'utils', () => {
	describe( 'getWikipediaAttrFromUrl', () => {
		...
		const tests = [
			...
			{ url: 'https://he.wikipedia.org/wiki/ירח#Section', expected: { lang: 'he', mobile: false, title: 'ירח#Section' } },
			...
			{ url: 'https://en.wikipedia.org/wiki/Cat#Section', expected: { lang: 'en', mobile: false, title: 'Cat#Section' } },
