...
describe( 'API', () => {
	describe( 'requestPagePreview', () => {
		test( 'transforms the API output', () => {
			const apiOutput = {
				type: 'standard',
				dir: 'ltr',
		...
		test( 'transforms the API output (without image, RTL)', () => {
			const apiOutput = {
				type: 'standard',
				dir: 'rtl',
				titles: { canonical: 'Dog' },
		...
		test( 'transforms the API output (no-extract with description)', () => {
			const apiOutput = {
				type: 'no-extract',
				dir: 'rtl',
				titles: { canonical: 'Dog' },
		...
		test( 'transforms the API output (no-extract NO description)', () => {
			const apiOutput = {
				type: 'no-extract',
				dir: 'rtl',
				titles: { canonical: 'Dog' }
		...
		test( 'transforms the API output (unsupported type)', () => {
			const apiOutput = {
				type: 'unsupported'
			}
			requestPagePreview( 'lang', 'title', ( data ) => {
	...
	describe( 'requestPageMedia', () => {
		...
		test( 'transforms the API output (without captions)', () => {
			const apiOutput = {
				items: [
					{
						/* eslint-disable camelcase */
	...
	describe( 'requestPageMediaInfo', () => {
		...
		test( 'transforms the API output when image is not from Common', () => {
			const apiOutput = {
				continue: {
